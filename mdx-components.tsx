...
const components = {
  h1: (props: HeadingProps) => (
    <h1 className="font-bold text-md md:text-lg pt-12 mb-0" {...props} />
  ),
  ...
  a: ({ href, children, ...props }: AnchorProps) => {
    const className =
      "text-blue-500 hover:text-blue-700 dark:text-gray-400 hover:dark:text-gray-300 dark:underline dark:underline-offset-2 dark:decoration-gray-800 break-words overflow-wrap-anywhere";
    if (href?.startsWith("/")) {
      return (
